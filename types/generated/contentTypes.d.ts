...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    brandVideo: Schema.Attribute.JSON &
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoryImg: Schema.Attribute.String &
    ...
    categoryVideo: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<'plugin::video-field.video'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    collectionVideo: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<'plugin::video-field.video'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiProductTypeProductType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'typeName'>;
    typeDescription: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    typeImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Attribute: Schema.Attribute.Component<'product.attribute', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    cloudinaryImage: Schema.Attribute.String &
      Schema.Attribute.CustomField<'plugin::cloudinary-media-library.cloudinary'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
